...
const Card = ({title,url,image,date}:Props) => {
  return <div className='bg-white cursor-pointer text-slate-700 drop-shadow-xl hover:drop-shadow-2xl	relative w-[320px] min-h-[330px] flex flex-col items-start justify-start gap-2  rounded-md  hover:scale-105 duration-150'>
